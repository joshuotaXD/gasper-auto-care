...
export default function Home() {
  ...
  // Estado para alternar entre las tarjetas de redes sociales en la vista de contacto
  const [socialTab, setSocialTab] = useState('whatsapp'); // 'whatsapp' o 'instagram'
              ...
              <section className="px-6 py-20 max-w-2xl mx-auto">
                <div className="bg-[#16181d] border border-zinc-800 rounded-3xl p-8 md:p-10 shadow-2xl text-center">
                  ...
                  <p className="text-zinc-400 mt-2 text-sm max-w-md mx-auto">
                    ¿Tienes dudas o necesitas atención personalizada? Escanea el código QR o haz clic en los botones para conectar directamente con nosotros.
                  </p>
                  
                  {/* Selector de pestañas para las Redes Sociales / Canales de Contacto */}
                  ...
                  {/* Tarjeta de Contenido Dinámica según socialTab */}
                  {socialTab === 'whatsapp' ? (
                    ...
                    <div className="mt-6 bg-[#111318] border border-zinc-700/80 rounded-3xl p-6 md:p-8 shadow-xl max-w-sm mx-auto flex flex-col items-center relative overflow-hidden group">
                      ...
                      <p className="text-xs text-zinc-400 mt-1 mb-6">Síguenos en Instagram</p>
                      ...
                      <p className="text-xs text-zinc-400 mt-6 leading-relaxed px-2">
                        Escanea el código QR para ver nuestras historias, reels y trabajos recientes en Instagram.
                      </p>
                    ...
                    <div className="mt-6 bg-[#111318] border border-zinc-700/80 rounded-3xl p-6 md:p-8 shadow-xl max-w-sm mx-auto flex flex-col items-center relative overflow-hidden group">
                      ...
                      <h3 className="text-xl font-bold text-white tracking-wide">Gasper Auto Detailing</h3>
                      <p className="text-xs text-zinc-400 mt-1 mb-6">Comunidad de Facebook</p>
                      ...
                      <div className="bg-zinc-900 p-8 rounded-2xl shadow-inner border border-zinc-800 flex flex-col items-center justify-center relative w-full h-44">
                        ...
                        <p className="text-xs text-zinc-400 mt-4 text-center">Conéctate con nosotros en Facebook</p>
                      </div>

                      <p className="text-xs text-zinc-400 mt-6 leading-relaxed px-2">
                        Visita nuestra página de Facebook para enterarte de promociones y reseñas.
                      </p>
